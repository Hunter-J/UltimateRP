if(pickingup)exitwith{player commandChat "you are already picking up an item"};
pickingup = true;
...
if (_amount <= 0) exitWith {player commandChat localize "STRS_inv_buyitems_maxgewicht"; _exitvar = 1;pickingup = false;};
...
player commandChat format["You picked up %1 %2", _amount, _name];	
