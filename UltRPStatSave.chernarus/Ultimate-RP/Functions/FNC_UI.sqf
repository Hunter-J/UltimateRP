...
_Street = player getVariable "Street";
	...
	if (RPM_Cop or RPM_FF) then {
		...
		101 cutRsc ["UltRP_Dlg_UI2", "PLAIN"];
		((UltRP_display_ui2 select 0) displayCtrl 1) ctrlSetStructuredText parseText format["<t color='#1AE14F'align='left'>City/Town:</t><t color='#E2B31A'align='left'> %1</t><br/><t color='#1AE14F'align='left'>Street:</t><t color='#E2B31A'align='left'> %2</t>", _Town, _Street];
