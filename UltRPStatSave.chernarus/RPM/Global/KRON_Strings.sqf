...
KRON_StrMid = {
    private ["_in","_pos","_len","_arr","_out"];
    _in=_this select 0;
...
KRON_StrIndex = {
    private ["_hay","_ndl","_lh","_ln","_arr","_tmp","_out"];
    _hay=_this select 0;
    _ndl=_this select 1;
    _out=-1;
    //_i=0;
...
KRON_Replace = {
    private ["_str","_old","_new","_out","_tmp","_la","_lo","_arr"];
    _str=_this select 0;
    _arr=toArray(_str);
    _la=count _arr;
    _old=_this select 1;
...
KRON_Compare = {
    private ["_k","_n","_s","_t","_s1","_s2","_l1","_l2","_l"];
...
KRON_ArraySort = {
    private ["_a","_d","_k","_s","_vo","_v1","_v2","_j","_c"];
    _a = +(_this select 0);
...
KRON_getArg = {
    private ["_in","_flg","_fl","_arr","_as","_aa","_org","_p","_out"];
    _in=_this select 0;
    _flg=toUpper(_this select 1);
