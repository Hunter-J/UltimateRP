        ...
        switch (_itemid) do {
            ...
            case 563: {
                ...
                if ((([521] call RPM_Cfg_Inv_GetItemAmount) + _newcash) <= RPM_MAX_NUMBER) then {
                    ...
                    hint format[localize "v387", _amount, ([521] call RPM_Cfg_Inv_GetItemAmount) + _newcash];
                    _use = true;
                    _nomsg = true;
                } else {
            ...
            case 564: {
                ...
                if ((([521] call RPM_Cfg_Inv_GetItemAmount) + _newcash) <= RPM_MAX_NUMBER) then {
                    [521, _newcash] call RPM_Cfg_Inv_AddItemAmount;
                    hint format[localize "v388", _amount, ([521] call RPM_Cfg_Inv_GetItemAmount) + _newcash];
                    _use = true;
                    _nomsg = true;
                } else {
                    hint format[localize "v389", _amount, _itemname, i0];
    ...
    if (_uid call RPM_str_Length >= 1) then {
        ...
        for [{_i = 1}, {_i < count(RPM_Stats_PersonalArray)}, {_i = _i + 1}] do {
            ...
            switch (_i) do {
                ...
                case 3: {
                    _str = _str + format["%1/100", call RPM_Cfg_Inv_GetHealth];
                };
                case 4: {
        ...
        for [{_i = 1}, {_i < count(RPM_Stats_InfoArray)}, {_i = _i + 1}] do {
            ...
            switch (_i) do {
                ...
                case 4: {
                    _newstr = format[localize "STRM_BankAccount"] + ": " + format["$%1", floor(i4)];
                    (RPM_Stats_InfoArray select _i) set[0, _newstr];
                    _str = (RPM_Stats_InfoArray select _i) select 0;
                };
                case 5: {
